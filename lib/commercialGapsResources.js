...
// both untouched.
//
// Updated 08/08/2026: added a tenth article, "The Connection Isn't the
// Sale", supplied directly by Tom. Tagged "demand", reassigned outright
// from case_study_aesthetic_clinics_margin below (which keeps "pricing").
//
// Updated 09/08/2026: added an eleventh article, "The Monument to Wasted
// Money", found during a Drive reconciliation pass (marked "Finished and
// saved as a standalone Useful Thinking article" in the Arrington Useful
// Thinking Map). Tagged "commercial_priorities", reassigned outright from
// case_study_abacus_falmouth below (which keeps "owner_dependency" and
// "business_model").
//
...
const RESOURCES = [
  ...
  },
  {
    ...
    title: 'Useful Thinking: "The Customer Who Messaged at 4am"',
  ...
  },
  {
    ...
    // Title corrected 09/08/2026 back to the Drive-approved original,
    // matching the article's own heading — see db/seed.js's title-revert
    // migration.
    title: 'Useful Thinking: "You Don\'t Get to Decide When You\'ve Made Things Right"',
  ...
  },
  {
    ...
    type: 'case_study',
    categories: ['owner_dependency', 'business_model'],
  ...
  {
    // Added 08/08/2026, supplied directly by Tom. "demand" reassigned here
    // outright (removed from case_study_aesthetic_clinics_margin above,
    // which keeps its other genuine category, "pricing") — a story about
    // judging when to chase a connection versus letting a genuine
    // introduction arrive on its own is a more precise match for demand's
    // real question ("chase, or comes to you?") than the general case
    // study.
    id: 'article_connection_isnt_the_sale',
    title: 'Useful Thinking: "The Connection Isn\'t the Sale"',
    url: 'https://www.arringtonconsultancy.com/useful-thinking/the-connection-isnt-the-sale',
    type: 'useful_thinking',
    categories: ['demand'],
    reasonTemplate: 'On the difference between chasing a connection and letting a genuine introduction arrive on its own, close to what your answer on {label} was pointing at.'
  },
  {
    // Added 09/08/2026, supplied directly by Tom. "commercial_priorities"
    // reassigned here outright (removed from case_study_abacus_falmouth
    // above, which keeps its other two genuine categories,
    // "owner_dependency" and "business_model") — a story about testing
    // whether a new revenue stream is worth what it costs the core
    // business is a more precise match for commercial_priorities' real
    // question ("growing revenue, protecting margin, freeing up your own
    // time, or something else?") than the general case study.
    id: 'article_monument_to_wasted_money',
    title: 'Useful Thinking: "The Monument to Wasted Money"',
    url: 'https://www.arringtonconsultancy.com/useful-thinking/the-monument-to-wasted-money',
    type: 'useful_thinking',
    categories: ['commercial_priorities'],
    reasonTemplate: 'On testing what a new revenue stream costs the core business before scaling it, close to what your answer on {label} was pointing at.'
  }
];
