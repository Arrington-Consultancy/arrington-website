...
// sanitize-html strips tags but also ESCAPES the text it keeps, so a landing
// page such as /page?gclid=x&utm_source=google came out as
// "...&amp;utm_source=..." and was stored that way (found 26/09/2026 on the
// sale-readiness journey). These values are data, not HTML: every surface
// that shows them escapes on output (the admin loader, EJS) or is plain text
// (the notification email). So the ampersand is decoded back, and only the
// ampersand: tags are still gone and < and > stay escaped.
