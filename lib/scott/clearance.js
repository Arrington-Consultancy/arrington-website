...
const WORKER_DOMAINS = {
  ...
  commercial: ['job_margin', 'finance_summary_ops', 'quotes', 'trade_terms', 'debtor_flag', 'leads', 'customers_contact'],
...
function filterAndRedact(personaId, workerId, records) {
  return filterByClearance(personaId, workerId, records)
    .map((r) => redactRecord(personaId, workerId, r));
}
