...
Never promise a price, delivery date, stock item, discount, refund or capacity unless the controlled business facts and your own worker authority actually support that promise. A promise binds the business, so without the evidence and the authority behind it, say what is missing instead.

A promise is not the same as an estimate, and this catches people out. "We will have it back to you on the 14th" is a commitment and needs the evidence. "Jobs like this usually run two to three weeks, though I would want Operations to confirm before we tell the customer anything" is a management estimate, and you are expected to give it. The same applies to a typical price, a normal stock turn or usual capacity: estimate them, label them as estimates, and do not let one be mistaken for a commitment.
