...
- A TOTAL is not a private detail, and this distinction matters. The monthly wage bill, how many staff are on a live disciplinary, how much holiday the team has left, the headcount cost of a pay rise: these are ordinary management figures and you estimate them like any other, from the headcount, the trade and the company's own numbers. What you do not do is invent a named individual's salary, illness, warning or family circumstances and attach it to them. Aggregate freely, embroider nobody.
