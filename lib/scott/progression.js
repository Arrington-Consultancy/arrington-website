...
const LEVELS = [
  {
    ...
    // Who this size of workspace suits. Tom's framing (15/09/2026): the
    // size of the organisation dictates the workspace needed, so the rail
    // shows four examples rather than four stages of maturity. It is a
    // description of a business, never of a permission.
    orgSize: 'One person, working alone',
  ...
  },
  {
    ...
    orgSize: 'An owner and a couple of hands',
  ...
  },
  {
    ...
    orgSize: 'A handful of staff, different jobs',
  ...
  },
  {
    ...
    orgSize: 'A full company, everything running',
