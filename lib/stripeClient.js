...
let client = null;
// One of 'ok' | 'unset' | 'live_key_refused' — never the key itself. Lets
// callers (e.g. the webhook diagnostic log in routes/whereToStart.js)
// report the *specific* reason payments aren't configured rather than a
// single "unset or refused" guess covering two very different problems:
// nobody has set STRIPE_SECRET_KEY at all, versus someone has set a real
// live key that this branch is deliberately refusing to use.
let keyStatus = 'unset';
...
module.exports = { getStripeClient, getStripeKeyStatus };
