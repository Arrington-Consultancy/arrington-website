...
const THIRTEENTH_PUBLISHED_ARTICLE = {
  slug: 'you-can-train-but-you-shouldnt-blame',
  instanceId: 'article__14',
  title: "You Can Train, But You Shouldn't Blame"
};

const FOURTEENTH_PUBLISHED_ARTICLE = {
  slug: 'the-most-expensive-person-doing-the-job-might-be-you',
  instanceId: 'article__15',
  title: 'The Most Expensive Person Doing the Job Might Be You'
};

const FIFTEENTH_PUBLISHED_ARTICLE = {
  slug: 'the-little-things-you-have-to-give-up',
  instanceId: 'article__16',
  title: 'The Little Things You Have to Give Up'
};
