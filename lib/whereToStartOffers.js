...
//
// CURRENT STATE (14/09/2026, settled): all five are approved. Tom confirmed
// these as the current public prices — Commercial Review £500, Commercial
// Review and Implementation £2,500, Commercial Review and Website Build
// £3,400, Website Build £999, and the conversation free — so no figure here is
// outstanding, provisional or awaiting reconciliation. They are simply what
// Arrington charges today.
//
// £500 IS NOT A DISCOUNT. Tom's instruction, verbatim: "Do not describe £500
// as a discount, introductory price or 50% offer. It is simply the current
// public price." Nothing on the site may frame it as a reduction from some
// other number, a launch rate, or an offer that will end.
//
// History, kept because the mechanism only makes sense with it: earlier the
// same day £999 alone was approved for the Product Guide and the other three
// were withheld. Tom asked why only two were priced, and the answer that
// settled it is that all three were already public one click away. That is
// what led to the full approval recorded above.
//
...
const OFFERS = {
  ...
  commercial_review: {
    ...
    pricePence: 50000,
    currency: 'gbp',
    // The current public price, confirmed by Tom 14/09/2026. Never framed as
    // a discount, an introductory rate or a 50% offer; see the note above.
    publicPriceApproved: true,
    purchasable: true,
  ...
  full_commercial_review: {
    ...
    pricePence: 250000,
    currency: 'gbp',
    // The current public price, confirmed by Tom 14/09/2026.
    publicPriceApproved: true,
