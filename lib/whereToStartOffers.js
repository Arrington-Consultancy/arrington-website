...
const OFFERS = {
  ...
  commercial_review: {
    ...
    // review: Tom listens for as long as it takes, then produces a written
    // assessment, recommendations, direction and next steps.
    description: "A genuine, standalone Commercial Review. Tom listens for as long as it takes to properly understand the business, then produces a written assessment, recommendations and next steps within 4 business days.",
    pricePence: 50000,
    currency: 'gbp',
    purchasable: true,
