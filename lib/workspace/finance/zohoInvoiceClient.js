...
// Three scopes, all read-only: invoices, customer payments, contacts. No write
...
// The customer-payments module scope is ZohoInvoice.customerpayments.READ,
// not ZohoInvoice.payments.READ ("payments" is not a Zoho Invoice module).
// The wrong name still passed the consent screen and read /invoices fine,
// but /customerpayments returned 401 "not authorized to perform this
// operation" because the token carried no scope for that endpoint - the
// exact symptom seen on 06/09/2026. Changing this requires a fresh consent,
// since the granted scopes are frozen into the refresh token at consent time.
