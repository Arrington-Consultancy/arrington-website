...
const ROUTING_RULES = [
  ...
  { laneId: 'opportunity_builder', pattern: /\b(opportunit|lead(s)?\b|prospect|pipeline|proposal|commercial conversation|ivybridge|icabbi)\b/i },
  ...
  // ---- LOW-PRECEDENCE TAIL ----
  //
  // Everything above is exactly as it was before this change. Every
  ...
  { laneId: 'ai_recommendation_visibility', pattern: /\bshortlists\b/i },
