...
const TAIL_RULES = [
  ...
  //
  // Five review rounds each found another word with that shape:
  ...
  // double space, and the absent trailing \b covers 'costing' as well as
  // 'cost' and 'costs'. "Which opportunity costs the most?" is blocked
  ...
  // finance can be read.
  { laneId: 'opportunity_builder', pattern: /\bopportunit(?:y(?![\s-]*cost)|ies)\b/i }
];
