...
const TAIL_RULES = [
  ...
  // argument would apply to them: against the current 29-record snapshot
  // the widest of them, website_hosting and ai_workspace_builder, reach
  // 23 records against a cap of 24. Under it, but by one record, so this
  // is worth re-measuring before the snapshot grows. Repairing an inflection is not worth a truncated
