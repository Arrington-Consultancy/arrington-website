...
// selects a lane's context; it is not a persona, never speaks as a
// person, and no tenth worker identity exists.
//
...
// The general (no-lane) context: core authority and register state only.
const GENERAL_SOURCE_CLASSES = ['authority', 'strategy', 'worker_register'];
