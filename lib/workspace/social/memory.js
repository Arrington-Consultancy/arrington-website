...
// The published Useful Thinking articles. The live site is the source of
...
].map((a) => ({ ...a, published: true, dateRecorded: null, source: SOURCE_ARTICLES }));
...
const MEMORY_GAPS = [
  { item: 'Dates for the LinkedIn posts', position: 'NOT LOGGED', detail: 'Every LinkedIn entry on the record reads "Date posted: Not yet logged". The Facebook and Instagram posts carry a day and month but no year. Ordering and anniversary prompts are therefore unavailable, and no date on this page is inferred.' },
  { item: 'Publication dates for the Useful Thinking articles', position: 'NOT RECORDED ANYWHERE', detail: 'The articles carry a slug, a heading and body copy, but no published date in the CMS or the article module. Thirteen are live; when each went live is not written down.' },
