...
const GATED = [
  ...
  { file: 'scott/memory/liveMemoryPressure.test.js', name: 'evolving memory live-AI pressure (SPENDS MONEY)', arms: 'RUN_SCOTT_MEMORY_LIVE_TEST=true + ANTHROPIC_API_KEY + ENABLE_SCOTT_AI=true + DATABASE_URL' },
